...
use crate::{app::body_id::BodyID, core_plugin::BodyInfo};

pub struct SearchPlugin;

impl Plugin for SearchPlugin {
    fn build(&self, app: &mut App) {
        app.add_systems(PostStartup, initialize_search)
            .add_systems(Update, update_search_entries);
    }
}
